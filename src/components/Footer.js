    ...
    <div className="relative container mx-auto px-10">
      ...
      <div className="lg:flex justify-between space-y-12 lg:space-y-0">
        ...
        <div className="flex flex-col justify-center">
          ...
          <form action="" method="POST" className="flex" onSubmit={fnAlert}>
            <input
              type="email"
              name="email"
            ...
            />
            <button className="p-3 bg-purple-400 text-purple-100 rounded-r">
              Subscribe
            </button>
          </form>
        </div>
        ...
        <div className="text-center lg:text-right md:flex md:justify-center md:space-x-8 space-y-8 md:space-y-0">
          <div className="space-y-2">
            ...
            <Link to="#" className="block hover:text-gray-800 hover:underline">
              About
            </Link>
            <Link to="#" className="block hover:text-gray-800 hover:underline">
              Blog
