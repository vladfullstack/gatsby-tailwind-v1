...
const IndexPage = () => (
  ...
  <div class="lg:pt-12 pb-24 bg-gray-300 lg:text-center">
    <div class="container mx-auto px-10">
      ...
      <p class="mb-12 lg:text-xl leading-loose">Hey there! My name is <Link to="https://twitter.com/chris__sev"
          class="text-blue-500 hover:underline">Chris Sev</Link> and I founded a web dev
      ...
      <div class="lg:flex lg:space-x-8 text-left space-y-8 lg:space-y-0">
        <div class="lg:w-1/2 bg-white border-2 border-gray-700 rounded shadow-xl">
          <p class="text-lg p-4 text-gray-700">Getting Started with Tailwind on scotch.io and a 15
            minute starter YouTube video.</p>

          <iframe class="w-full rounded-b" height="315" src="https://www.youtube.com/embed/6zIuAyLZPH0" frameborder="0"
            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="lg:w-1/2 bg-white border-2 border-gray-700 rounded shadow-xl">
          <p class="text-lg p-4 text-gray-700">I did a Build Your 1st Tailwind Site for Traversy Media on YouTube also.
          </p>
